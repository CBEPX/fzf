...
type Result struct {
	...
	// But we slightly adjust the score according to the following rules:
	//
	// 1. If the first rune of the pattern is found at the beginning of
	//    a word, we decrease matchlen by 1 (bonus).
	// 2. For the rest of the matching runes, if a rune is found at the beginning
	//    of a word, there is no bonus or penalty.
	// 3. Otherwise, we increase matchlen by 1 (penalty).
	// 4. Bonus or penalty is considered at most once for a word
	Bonus int32
}
